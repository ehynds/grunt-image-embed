...
exports['test css encoding'] = {
    ...
    "trivial case -- can process a basic css file": function(test) {
        ...
        grunt.helper("encode_stylesheet", input, function(err, str) {
            test.equal(str, "body {/* local images */}\r\n");
            test.done();
        });
    },
